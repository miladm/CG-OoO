...
# ####
# ../../../../pin/pin -t ./obj-intel64/parser.so -b 429.mcf -- /home/milad/zsim-apps/build/speccpu2006/429.mcf/429.mcf ~/zsim-apps/inputs/429.mcf/test/input/inp.in
...
#####
# ../../../../pin/pin -t ./obj-intel64/parser.so -b 445.gobmk -- ~/zsim-apps/build/speccpu2006/445.gobmk/445.gobmk --quiet --mode gtp <~/zsim-apps/inputs/445.gobmk/test/input/capture.tst
...
#####
# ../../../../pin/pin -t ./obj-intel64/parser.so -b 456.hmmer -- ~/zsim-apps/build/speccpu2006/456.hmmer/456.hmmer --fixed 0 --mean 325 --num 45000 --sd 200 --seed 0 ~/zsim-apps/inputs/456.hmmer/test/input/bombesin.hmm
...
#####
# ../../../../pin/pin -t ./obj-intel64/parser.so -b 458.sjeng -- ~/zsim-apps/build/speccpu2006/458.sjeng/458.sjeng ~/zsim-apps/inputs/458.sjeng/test/input/test.txt
...
# /home/milad/esc_project/svn/pin/pin -t $FRONTEND_PATH/obj-intel64/parser.so -b 471.omnetpp -- ./471.omnetpp /home/milad/zsim-apps/inputs/471.omnetpp/test/input/omnetpp.ini
# cd $FRONTEND_PATH
...
#####
# ../../../../pin/pin -t ./obj-intel64/parser.so -b 473.astar -- ~/zsim-apps/build/speccpu2006/473.astar/473.astar ~/zsim-apps/inputs/473.astar/test/input/lake.cfg
...
#####
# ../../../../pin/pin -t ./obj-intel64/parser.so -b 483.xalancbmk -- ~/zsim-apps/build/speccpu2006/483.xalancbmk/483.xalancbmk -v ~/zsim-apps/inputs/483.xalancbmk/test/input/test.xml ~/zsim-apps/inputs/483.xalancbmk/test/input/xalanc.xsl
...
######
# ../../../../pin/pin -t ./obj-intel64/parser.so -b 401.bzip2 -- ~/zsim-apps/build/speccpu2006/401.bzip2/401.bzip2 ~/zsim-apps/inputs/401.bzip2/test/input/dryer.jpg 2
...
#####################################
#../../../../pin/pin -t ./obj-intel64/parser.so -b  -- ../../../../benchmarks/spec2006/bzip2/bzip2 ../../../../benchmarks/spec2006/bzip2/sample2.ref
