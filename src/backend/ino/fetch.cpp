...
SIM_MODE fetch::doFETCH (FRONTEND_STATUS frontend_status) {
...
PIPE_ACTIVITY fetch::fetchImpl (FRONTEND_STATUS frontend_status) {
    PIPE_ACTIVITY pipe_stall = PIPE_STALL;
...
bool fetch::isGoToFrontend (FRONTEND_STATUS frontend_status) {
