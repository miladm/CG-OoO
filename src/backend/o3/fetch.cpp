...
SIM_MODE o3_fetch::doFETCH (sysClock& clk) {
    /* STAT + DEBUG */
...
PIPE_ACTIVITY o3_fetch::fetchImpl (sysClock& clk) {
    PIPE_ACTIVITY pipe_stall = PIPE_STALL;
...
void o3_fetch::squash (sysClock& clk) {
...
void o3_fetch::regStat (sysClock& clk) {
