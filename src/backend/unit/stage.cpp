...
stage::stage(WIDTH stage_width, string stage_name, const YAML::Node& root, sysClock* clk) 
	: _stage_name(stage_name),
      ...
      s_ipc  (g_stats.newRatioStat (clk->getStatObj (), stage_name, "ipc", "Instructions per cycle of " +stage_name, 0, NO_PRINT_ZERO)),
