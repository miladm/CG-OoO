...
CFG_FILE=$1
PIN_PARAM=-separate_memory  0 #-pin_memory_range 0x80000000:0x90000000 -pause_tool 15 
...
#$PIN_ROOT/pin -t $PARS_ROOT/obj-intel64/main_pars.so -b $CFG_PATH/458.sjeng -c $CFG_PATH/$CFG_FILE -o $OUT_PATH -- $BENCH_EXEC/458.sjeng/458.sjeng $BENCH_INPUT/458.sjeng/test/input/test.txt
