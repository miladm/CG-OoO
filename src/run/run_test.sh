...
#$PIN_ROOT/pin $PIN_PARAM -t $PARS_ROOT/obj-intel64/main_pars.so -b $CFG_PATH/401.bzip2 -c $CFG_PATH/$CFG_FILE -- $BENCH_EXEC/401.bzip2/401.bzip2  $BENCH_INPUT/401.bzip2/test/input/dryer.jpg 2
...
#$PIN_ROOT/pin $PIN_PARAM -t $PARS_ROOT/obj-intel64/main_pars.so -b $CFG_PATH/464.h264ref -c $CFG_PATH/$CFG_FILE -- $BENCH_EXEC/464.h264ref/464.h264ref  -d $BENCH_INPUT/464.h264ref/test/input/foreman_test_encoder_baseline.cfg -p InputFile="$BENCH_INPUT/464.h264ref/all/input/foreman_qcif.yuv"
