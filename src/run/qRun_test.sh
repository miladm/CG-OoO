...
qsub -e $OUT_PATH -o $OUT_PATH -V -l p=16 -pe smp 1 -S /bin/sh -N ts_bzip2      $RUN_DIR/run.sh -b $CFG_PATH/401.bzip2      -c $CFG_PATH/$CFG_FILE -o $OUT_PATH -- $BENCH_EXEC/401.bzip2/401.bzip2 $BENCH_INPUT/401.bzip2/test/input/dryer.jpg 2
qsub -e $OUT_PATH -o $OUT_PATH -V -l p=16 -pe smp 1 -S /bin/sh -N ts_hmmer      $RUN_DIR/run.sh -b $CFG_PATH/456.hmmer      -c $CFG_PATH/$CFG_FILE -o $OUT_PATH -- $BENCH_EXEC/456.hmmer/456.hmmer --fixed 0 --mean 325 --num 45000 --sd 200 --seed 0  $BENCH_INPUT/456.hmmer/test/input/bombesin.hmm
qsub -e $OUT_PATH -o $OUT_PATH -V -l p=16 -pe smp 1 -S /bin/sh -N ts_sjeng      $RUN_DIR/run.sh -b $CFG_PATH/458.sjeng      -c $CFG_PATH/$CFG_FILE -o $OUT_PATH -- $BENCH_EXEC/458.sjeng/458.sjeng $BENCH_INPUT/458.sjeng/test/input/test.txt
qsub -e $OUT_PATH -o $OUT_PATH -V -l p=16 -pe smp 1 -S /bin/sh -N ts_gobmk      $RUN_DIR/run.sh -b $CFG_PATH/445.gobmk      -c $CFG_PATH/$CFG_FILE -o $OUT_PATH -- $BENCH_EXEC/445.gobmk/445.gobmk --quiet --mode gtp < $BENCH_INPUT/445.gobmk/test/input/capture.tst
qsub -e $OUT_PATH -o $OUT_PATH -V -l p=16 -pe smp 1 -S /bin/sh -N ts_libquantum $RUN_DIR/run.sh -b $CFG_PATH/462.libquantum -c $CFG_PATH/$CFG_FILE -o $OUT_PATH -- $BENCH_EXEC/462.libquantum/462.libquantum 33 5
...
qsub -e $OUT_PATH -o $OUT_PATH -V -l p=16 -pe smp 1 -S /bin/sh -N ts_astar      $RUN_DIR/run.sh -b $CFG_PATH/473.astar      -c $CFG_PATH/$CFG_FILE -o $OUT_PATH -- $BENCH_EXEC/473.astar/473.astar $BENCH_INPUT/473.astar/test/input/lake.cfg
qsub -e $OUT_PATH -o $OUT_PATH -V -l p=16 -pe smp 1 -S /bin/sh -N ts_xalancbmk  $RUN_DIR/run.sh -b $CFG_PATH/483.xalancbmk  -c $CFG_PATH/$CFG_FILE -o $OUT_PATH -- $BENCH_EXEC/483.xalancbmk/483.xalancbmk -v $BENCH_INPUT/483.xalancbmk/test/input/test.xml $BENCH_INPUT/483.xalancbmk/test/input/xalanc.xsl
qsub -e $OUT_PATH -o $OUT_PATH -V -l p=16 -pe smp 1 -S /bin/sh -N ts_perlbench  $RUN_DIR/run.sh -b $CFG_PATH/400.perlbench  -c $CFG_PATH/$CFG_FILE -o $OUT_PATH -- $BENCH_EXEC/400.perlbench/400.perlbench -I. -I $BENCH_INPUT/400.perlbench/all/input/lib/ $BENCH_INPUT/400.perlbench/test/input/attrs.pl

cd $BENCH_INPUT/471.omnetpp/test/input
qsub -e $OUT_PATH -o $OUT_PATH -V -l p=16 -pe smp 1 -S /bin/sh -N ts_omnetpp    $RUN_DIR/run.sh -b $CFG_PATH/471.omnetpp    -c $CFG_PATH/$CFG_FILE -o $OUT_PATH -- $BENCH_EXEC/471.omnetpp/471.omnetpp -d omnetpp.ini
