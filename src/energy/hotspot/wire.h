...
#elif defined(TECHNODE45)
	#define	WIRE_R_G		273.0
	#define	WIRE_C_G		0.357
	#define	WIRE_R_I		1041.6
	#define	WIRE_C_I		0.341
	#define	WIRE_LCRIT_G	0.95
	#define	WIRE_SOPT_G		40.0
#endif	
...
#define WIRE_ENERGY_G		80 //pJ/b-m
#define WIRE_ENERGY_I		80 //pJ/b-m


/* function for wire-length to wire-delay conversion	*/
double wire_length2delay(double length, int layer);

double wire_length2energy(double length, int layer);
