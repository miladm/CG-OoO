...
area = cache.dataarray_size[0]*1e3 * cache.dataarray_size[1]*1e3
print 'Dimensions = %.6f mm x %.6f mm (%.6f mm^2)' % (cache.dataarray_size[0]*1e3, cache.dataarray_size[1]*1e3, area)
