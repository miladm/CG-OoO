...
BASICALLY A WRAPPER CLASS TO HOLD BOTH THE BRANCH PREDICTOR AND THE \hyperlink{classBTB}{BTB}.

Basically a wrapper class to hold both the branch predictor and the \hyperlink{classBTB}{BTB}. 

\subsection{Constructor \& Destructor Documentation}
\hypertarget{classBPredUnit_a4d632a2a34745803315809aedf2ce9b1}{
\index{BPredUnit@{BPredUnit}!BPredUnit@{BPredUnit}}
\index{BPredUnit@{BPredUnit}!BPredUnit@{BPredUnit}}
\subsubsection[{BPredUnit}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Impl $>$ {\bf BPredUnit}$<$ Impl $>$::{\bf BPredUnit} (
\begin{DoxyParamCaption}
\item[{DerivO3CPUParams $\ast$}]{params}
\end{DoxyParamCaption}
)}}
\label{classBPredUnit_a4d632a2a34745803315809aedf2ce9b1}

\begin{DoxyParams}{Parameters}
{\em params} & The params object, that has the size of the BP and \hyperlink{classBTB}{BTB}. \\
\hline
\end{DoxyParams}
...
If a branch is not taken, because the \hyperlink{classBTB}{BTB} address is invalid or missing, this function sets the appropriate counter in the global and local predictors to not taken. 
\begin{DoxyParams}{Parameters}
...
{
    if (predictor == Local) {
        assert (false && "this function is not supported for loacl prediction - (
      see Milad!)");
    } else if (predictor == Hybrid) {
...
\end{DoxyCode}
\hypertarget{classBPredUnit_af381979dadd608af5d4d5a235050f335}{
\index{BPredUnit@{BPredUnit}!BPLookup@{BPLookup}}
\index{BPLookup@{BPLookup}!BPredUnit@{BPredUnit}}
\subsubsection[{BPLookup}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Impl $>$ bool {\bf BPredUnit}$<$ Impl $>$::BPLookup (
\begin{DoxyParamCaption}
...
\label{classBPredUnit_af381979dadd608af5d4d5a235050f335}
Looks up a given PC in the BP to see if it is taken or not taken. 
\begin{DoxyParams}{Parameters}
{\em inst\_\-PC} & The PC to look up. \\
\hline
...
\end{DoxyParams}
\begin{Desc}
\item[\hyperlink{todo__todo000003}{Todo}]Make this update flexible enough to handle a global predictor. \end{Desc}
...
Looks up a given PC in the \hyperlink{classBTB}{BTB} to get the predicted target. 
\begin{DoxyParams}{Parameters}
{\em inst\_\-PC} & The PC to look up. \\
\hline
\end{DoxyParams}
...
{\em inst\_\-PC} & The branch's PC that will be updated. \\
\hline
{\em target\_\-PC} & The branch's target that will be added to the \hyperlink{classBTB}{BTB}. \\
\hline
\end{DoxyParams}
...
Looks up a given PC in the \hyperlink{classBTB}{BTB} to see if a matching entry exists. 
\begin{DoxyParams}{Parameters}
{\em inst\_\-PC} & The PC to look up. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Whether the \hyperlink{classBTB}{BTB} contains the given PC. 
\end{DoxyReturn}
...
\hypertarget{classBPredUnit_a6b7b489094d02552a2e1a81aab1ed280}{
\index{BPredUnit@{BPredUnit}!dump@{dump}}
\index{dump@{dump}!BPredUnit@{BPredUnit}}
\subsubsection[{dump}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Impl $>$ void {\bf BPredUnit}$<$ Impl $>$::dump (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}
\label{classBPredUnit_a6b7b489094d02552a2e1a81aab1ed280}
...
\hypertarget{classBPredUnit_ad37b550622b7ed76b55d80cc28700699}{
\index{BPredUnit@{BPredUnit}!predict@{predict}}
\index{predict@{predict}!BPredUnit@{BPredUnit}}
\subsubsection[{predict}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Impl $>$ bool {\bf BPredUnit}$<$ Impl $>$::predict (
\begin{DoxyParamCaption}
...
\label{classBPredUnit_ad37b550622b7ed76b55d80cc28700699}
Predicts whether or not the instruction is a taken branch, and the target of the branch if it is taken. 
\begin{DoxyParams}{Parameters}
{\em inst} & The branch instruction. \\
\hline
...
\label{classBPredUnit_a0cffcea165538b2e7fd554a92b8d9b85}
Registers statistics. \hypertarget{classBPredUnit_a78e6f48f8a11db90daab850527d48aa7}{
...
\item 
/home/milad/esc\_\-project/svn/PARS/src/backend/bp/\hyperlink{backend_2bp_2bpred__unit_8h}{bpred\_\-unit.h}\item 
/home/milad/esc\_\-project/svn/PARS/src/forLater/\hyperlink{forLater_2bpred__unit_8h}{bpred\_\-unit.h}\item 
/home/milad/esc\_\-project/svn/PARS/src/backend/bp/\hyperlink{backend_2bp_2bpred__unit_8cpp}{bpred\_\-unit.cpp}\item 
/home/milad/esc\_\-project/svn/PARS/src/forLater/\hyperlink{bpred__unit__ctr_8h}{bpred\_\-unit\_\-ctr.h}\end{DoxyCompactItemize}
