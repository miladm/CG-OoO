...
\begin{DoxyCode}
                                         {
    Assert (_num_free_wr_port > 0 && "must have checked the available ports count
       first");
    Assert (getTableSize () > 0);
        return table<tableType_T>::_table.Last ()->_element;
}
\end{DoxyCode}
\hypertarget{classtable_a6876501119e77aa58a373c1f12c70b8d}{
...
\label{classtable_a6876501119e77aa58a373c1f12c70b8d}
...
\end{DoxyCode}
\hypertarget{classtable_a8c3b8032622fa8c6e85e9a4d5ded1a80}{
\index{table@{table}!hasFreeRdPort@{hasFreeRdPort}}
\index{hasFreeRdPort@{hasFreeRdPort}!table@{table}}
\subsubsection[{hasFreeRdPort}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename tableType\_\-T $>$ bool {\bf table}$<$ tableType\_\-T $>$::hasFreeRdPort (
\begin{DoxyParamCaption}
\item[{{\bf CYCLE}}]{now}
\end{DoxyParamCaption}
)}}
\label{classtable_a8c3b8032622fa8c6e85e9a4d5ded1a80}
...
\end{DoxyCode}
\hypertarget{classtable_a4da7f6326c21da45dbed8d618c3aabce}{
\index{table@{table}!hasFreeWrPort@{hasFreeWrPort}}
\index{hasFreeWrPort@{hasFreeWrPort}!table@{table}}
\subsubsection[{hasFreeWrPort}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename tableType\_\-T $>$ bool {\bf table}$<$ tableType\_\-T $>$::hasFreeWrPort (
\begin{DoxyParamCaption}
\item[{{\bf CYCLE}}]{now}
\end{DoxyParamCaption}
)}}
\label{classtable_a4da7f6326c21da45dbed8d618c3aabce}
...
\begin{DoxyCode}
                                                        {
    Assert ( _num_free_wr_port > 0 && "must have checked the available ports coun
      t first");
        if (getTableSize () >= _table_size) {
        dbg.print (DBG_PORT, "%s: %s (cyc: )\n", _c_name.c_str (), "is FULL");
        return FULL_BUFF;
...
\end{DoxyCode}
\hypertarget{classtable_a55389eaae41800d77cacc97c563491f0}{
...
\label{classtable_a55389eaae41800d77cacc97c563491f0}
...
\index{table@{table}!\_\-num\_\-free\_\-rd\_\-port@{\_\-num\_\-free\_\-rd\_\-port}}
\index{\_\-num\_\-free\_\-rd\_\-port@{\_\-num\_\-free\_\-rd\_\-port}!table@{table}}
...
\index{table@{table}!\_\-num\_\-free\_\-wr\_\-port@{\_\-num\_\-free\_\-wr\_\-port}}
\index{\_\-num\_\-free\_\-wr\_\-port@{\_\-num\_\-free\_\-wr\_\-port}!table@{table}}
...
\index{table@{table}!\_\-rd\_\-port\_\-cnt@{\_\-rd\_\-port\_\-cnt}}
\index{\_\-rd\_\-port\_\-cnt@{\_\-rd\_\-port\_\-cnt}!table@{table}}
...
\index{table@{table}!\_\-wr\_\-port\_\-cnt@{\_\-wr\_\-port\_\-cnt}}
\index{\_\-wr\_\-port\_\-cnt@{\_\-wr\_\-port\_\-cnt}!table@{table}}
