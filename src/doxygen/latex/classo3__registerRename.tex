...
\hypertarget{classo3__registerRename_afc40fa21233d279d229970c3a982a9b8}{
...
\label{classo3__registerRename_afc40fa21233d279d229970c3a982a9b8}
      ...
      _rd_port_cnt (8)
{
    ...
    Assert (_rd_port_cnt == 2 * _wr_port_cnt && "Must have twice as many read por
      ts than write ports.");
    Assert (_availablePRset.size () == GRRF_SIZE && "Invalid Rename table structu
      re initialization.");
    Assert (_RF.size () == GPRF_SIZE && "Invalid Rename table structure initializ
      ation.");
    Assert (_fRAT.size () == GARF_SIZE && "Invalid Rename table structure initial
      ization.");
    Assert (_cRAT.size () == GARF_SIZE && "Invalid Rename table structure initial
      ization.");
}
\end{DoxyCode}
\hypertarget{classo3__registerRename_a177992bb922a67442166f5cc0a1c09fe}{
\index{o3\_\-registerRename@{o3\_\-registerRename}!o3\_\-registerRename@{o3\_\-registerRename}}
\index{o3\_\-registerRename@{o3\_\-registerRename}!o3_registerRename@{o3\_\-registerRename}}
\subsubsection[{o3\_\-registerRename}]{\setlength{\rightskip}{0pt plus 5cm}o3\_\-registerRename::o3\_\-registerRename (
\begin{DoxyParamCaption}
\item[{{\bf AR}}]{a\_\-rf\_\-lo, }
\item[{{\bf AR}}]{a\_\-rf\_\-hi, }
\item[{{\bf WIDTH}}]{rd\_\-port\_\-cnt, }
\item[{{\bf WIDTH}}]{wr\_\-port\_\-cnt, }
\item[{string}]{rf\_\-name}
\end{DoxyParamCaption}
)}}
\label{classo3__registerRename_a177992bb922a67442166f5cc0a1c09fe}
      ...
      _rd_port_cnt (rd_port_cnt)
{
    ...
    Assert (_rd_port_cnt == 2 * _wr_port_cnt && "Must have twice as many read por
      ts than write ports.");
        Assert (_availablePRset.size () == GRRF_SIZE && "Invalid Rename table str
      ucture initialization.");
        Assert (_RF.size () == _p_rf_size && "Invalid Rename table structure init
      ialization.");
        Assert (_fRAT.size () == _a_rf_size && "Invalid Rename table structure in
      itialization.");
        Assert (_cRAT.size () == _a_rf_size && "Invalid Rename table structure in
      itialization.");
}
\end{DoxyCode}
...
\end{DoxyCode}
\hypertarget{classo3__registerRename_a641c81a3e668177ef756fbeaa7c0998f}{
\index{o3\_\-registerRename@{o3\_\-registerRename}!hasFreeRdPort@{hasFreeRdPort}}
\index{hasFreeRdPort@{hasFreeRdPort}!o3_registerRename@{o3\_\-registerRename}}
\subsubsection[{hasFreeRdPort}]{\setlength{\rightskip}{0pt plus 5cm}bool o3\_\-registerRename::hasFreeRdPort (
\begin{DoxyParamCaption}
\item[{{\bf CYCLE}}]{now, }
\item[{{\bf WIDTH}}]{numRegRdPorts}
\end{DoxyParamCaption}
)}}
\label{classo3__registerRename_a641c81a3e668177ef756fbeaa7c0998f}
...
\hypertarget{classo3__registerRename_aad6b322839a5349fd6895944f3907ff2}{
\index{o3\_\-registerRename@{o3\_\-registerRename}!hasFreeWrPort@{hasFreeWrPort}}
\index{hasFreeWrPort@{hasFreeWrPort}!o3_registerRename@{o3\_\-registerRename}}
\subsubsection[{hasFreeWrPort}]{\setlength{\rightskip}{0pt plus 5cm}bool o3\_\-registerRename::hasFreeWrPort (
\begin{DoxyParamCaption}
\item[{{\bf CYCLE}}]{now}
\end{DoxyParamCaption}
)}}
\label{classo3__registerRename_aad6b322839a5349fd6895944f3907ff2}
...
\begin{DoxyCode}
        ...
        Assert (_availablePRset.size () <= GRRF_SIZE && "Rename table has grown t
      oo large (size violation).");
}
\end{DoxyCode}
...
\begin{DoxyCode}
    ...
    Assert (_availablePRset.size () <= GRRF_SIZE && "Rename table has grown too l
      arge (size violation).");
}
\end{DoxyCode}
