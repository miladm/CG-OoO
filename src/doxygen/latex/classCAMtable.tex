...
\begin{DoxyCode}
    ...
    Assert ( table<tableType_T>::_num_free_rd_port > 0 && "must have checked the 
      available ports count first");
#endif
...
#ifdef ASSERTION
    Assert (table<tableType_T>::_table.NumElements () > 0);
    Assert (table<tableType_T>::_num_free_rd_port > 0 && "must have checked the a
      vailable ports count first");
#endif
