...
\begin{DoxyCode}
                                                               {
    if (lsq_id == LD_QU) {
        return _LQ.hasFreeWire (clk, WRITE); //TODO set state to LQ_ADDR_WAIT
    } else {
        return _SQ.hasFreeWire (clk, WRITE); //TODO set state to LQ_ADDR_WAIT
    }
}
\end{DoxyCode}
...
/home/milad/esc\_\-project/svn/PARS/src/backend/o3/\hyperlink{memManager_8cpp}{memManager.cpp}\item 
