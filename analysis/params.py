...
def init_params (result_map):
  ...
  result_map['LQ.rd_wire.e_w_lsq2lrf'] = 0.0
  result_map['LQ.rd_wire.e_w_lsq2grf'] = 0.0
  result_map['LQ.e_cam'] = 0.0
  result_map['LQ.e_ram'] = 0.0
  result_map['LQ.e_leak'] = 0.0
  result_map['dtlb.e_cam'] = 0.0
  result_map['itlb.e_cam'] = 0.0
  ...
  result_map['sysClock.clk_cycles'] = 0.0
  result_map['commit.ins_type_cnt_1'] = 0.0
  result_map['commit.ins_type_cnt_2'] = 0.0
  result_map['commit.ins_type_cnt_4'] = 0.0
  result_map['commit.ins_cnt'] = 0.0
  result_map['fetch.ins_cnt'] = 0.0
  result_map['memory.ins_cnt'] = 0.0
  result_map['execution.mem_mispred_cnt'] = 0.0
  result_map['pars.bp_misspred_cnt'] = 0.0
  result_map['pars.btb_misspred_cnt'] = 0.0
  result_map['pars.bpu_lookup_cnt'] = 0.0
  result_map['commit.bb_size_avg'] = 1.0 #TO ACCOUNT FOR "HEAD" INSTRUCTION
  result_map['schedule.bbWin_inflight_rat'] = 0.0
  result_map['LQ.size_rat'] = 0.0
