...
./call_run.sh $RESULTS_DIR/multi_bb_fetch/bw_per_cluster/4_bw/1_eu
./call_run.sh $RESULTS_DIR/multi_bb_fetch/bw_per_cluster/4_bw/2_eu
./call_run.sh $RESULTS_DIR/multi_bb_fetch/bw_per_cluster/4_bw/4_eu
./call_run.sh $RESULTS_DIR/multi_bb_fetch/bw_per_cluster/4_bw/8_eu
